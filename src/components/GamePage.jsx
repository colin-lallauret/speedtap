    ...
    const timer = setInterval(() => {
      setTimeLeft((prev) => {
        if (prev <= 1) {
          ...
          scoreService
            .isTopScore(finalWpm, finalAccuracy)
            .then((isTop) => {
              if (isTop) {
