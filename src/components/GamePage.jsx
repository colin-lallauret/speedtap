...
const SENTENCES = [
  ...
  "Les soirs d'été offrent une lumière dorée qui enveloppe doucement les paysages paisibles. Les arbres se découpent en ombre sur un ciel clair et chaud, tandis que les insectes chantent dans les herbes hautes. L'air sent la terre et les fleurs, empli d'une douceur que rien ne peut égaler. Les gens flânent dans les rues encore animées, savourant les dernières heures avant la nuit. Les rires, les voix et les pas résonnent dans les ruelles pleines de vie. Il y a dans ces instants une forme de bonheur simple, celle de sentir le temps ralentir et de profiter d'une soirée calme et lumineuse.",
